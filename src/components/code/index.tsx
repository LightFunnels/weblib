...
export function Icon(props: React.HTMLAttributes<HTMLOrSVGElement>){
	return (
	  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" {...props} className={clsx("lfui-codeIcon", props.className)} >
	    <title />
